    ...
    public class distancedColoring {
        public static void main(String[] args) {
            Scanner sc = new Scanner(System.in);
            int testcases = sc.nextInt();
            while(testcases > 0) {
                long m = sc.nextLong(), n = sc.nextLong(), k = sc.nextLong();
                long res = Math.min(m, k) * Math.min(n, k);
...
// You received an n×m
// grid from a mysterious source. The source also gave you a magic positive integer constant k
